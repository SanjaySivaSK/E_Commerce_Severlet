    ...
    <div class="container  col-4 mt-5 border rounded  ">
      <form method="post" action="login" >
        ...
        <div class="form-outline mt-5 mb-3">
          ...
          <input type="text" id="Email" name="email" class="form-control border-0 border-bottom w-75 ms-5 " />
        ...
        <div class="form-outline  mt-5  mb-4">
          ...
          <input type="text" id="Password" name="password" class="form-control border-0 border-bottom w-75 ms-5 " />
        ...
        <div class="col-12  mt-4 text-center">
          <!-- Simple link -->
          <P>Not a user?<a href="Register.jsp"</a>Register</P>
        </div>
